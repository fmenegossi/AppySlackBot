...
module.exports.generalMsg = (obj) => {
  ...
  switch (obj.msg) {
      ...
      case 'changedApi' :
        const text2 = 'Api on platform:'+obj.data.platformName+'\n name:'+obj.data.name+'\n was changed by:'+obj.optional.name+'\n on:'+obj.data.changed_at
        return messageFormat( text2 , SUCCESS_COLOR)

        break
      case 'changedPlatform' :
        const text2 = 'Platform '+obj.data.name+' was changed!'
        return messageFormat( text2 , SUCCESS_COLOR)

        break
      case 'addedPlatform' :
        const text2 = 'Platform '+obj.data.name+' was created!'
        return messageFormat( text2 , SUCCESS_COLOR)
